        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="http://localhost/kodepress_cms" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('asset_url') ? ' has-error ' : '' }}">
                    <label for="asset_url">
                        {{ trans('installer_messages.environment.wizard.form.asset_url_label') }}
                    </label>
                    <input type="url" name="asset_url" id="asset_url" value="http://localhost/kodepress_cms/public" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                {{-- <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_key" id="database_password" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
                    @if ($errors->has('database_password'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('database_password') }}
                ...
                <div class="form-group {{ $errors->has('purchase_key') ? ' has-error ' : '' }}">
                    <label for="purchase_key">
                        {{ trans('installer_messages.environment.wizard.form.purchase_key_label') }}
                    </label>
                    <input type="text" name="purchase_key" id="purchase_key" placeholder="{{ trans('installer_messages.environment.wizard.form.purchase_key_placeholder') }}" />
            ...
            <div class="tab" id="tab3content">
                ...
                <img style="display: none; margin-left: 30%;" src="{{ asset('assets/images/loader.svg') }}" id="loader" class="loader-img" alt="Loader">
                <div class="buttons">
                    <button class="button" onclick="install()" type="submit">
