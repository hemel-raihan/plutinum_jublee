...
@foreach($sub_category->childrenRecursive as $key => $sub)
    ...
    <div class="checkbox-group">
            <input type="checkbox" name="categorybox[]" value="{{$sub->name}}" data-src="{{$sub->id}}" data-id="{{$sub->slug}}" class="checkbox-normal group-checkbox-item-1636878492751 belongs-group-0-1636878492751" id="group_<?php echo $sub_category->id; ?>_checkbox_<?php echo $key ?>_1636878492752" />
