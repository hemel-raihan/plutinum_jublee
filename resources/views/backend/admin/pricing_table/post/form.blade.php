		...
		<div class="col-lg-9 col-xl-9 col-md-12 col-sm-12">
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <div class="form-group">
                        @isset($price)
                        <label class="form-label" for="type">Select Duration Type</label>
                        <select class="form-control form-select select2" data-bs-placeholder="Select Type" name="duration" id="type" >
                            <option value="">Select Layout</option>
                            <option value="Monthly" {{($price->duration == 'Monthly') ? 'selected' : ''}} >Monthly</option>
                            <option value="Yearly" {{($price->duration == 'Yearly') ? 'selected' : ''}}>Yearly</option>
                        </select>
                        @else
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control @error('price') is-invalid @enderror" value="{{$price->price ?? old('price')}}" name="price" id="" placeholder="Price">
                        @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
