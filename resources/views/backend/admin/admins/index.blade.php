...
@section('content')
						...
						<div class="page-header">
                            ...
                            @if($auth->hasPermission('app.users.create'))
								<a href="{{route('admin.admins.create')}}" class="btn btn-primary btn-icon text-white me-2">
									<span>
											...
											<table class="table border text-nowrap text-md-nowrap table-striped mg-b-0">
												...
												<tbody>
                                                    ...
                                                    @if($auth->hasPermission('app.users.edit'))
															...
															<a href="{{route('admin.admins.edit',$user->id)}}" class="btn btn-success">
                                                    ...
                                                    @if($auth->hasPermission('app.users.destroy'))
															...
															<form id="deleteform-{{$user->id}}" action="{{route('admin.admins.destroy',$user->id)}}" method="POST" style="display: none;">
															@csrf
															@method('DELETE')
															</form>
