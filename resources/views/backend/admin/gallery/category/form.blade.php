...
@section('content')
						...
						<div class="page-header">
							...
							<div class="ms-auto pageheader-btn">
								<a href="{{route('admin.gallerycategories.index')}}" class="btn btn-primary btn-icon text-white me-2">
									<span>
...
function fetchcategory()
{
    $.ajax({
        type: "GET",
        url: "{{route('admin.gallerycategories.fetch')}}",
        dtaType: "json",
        success: function(response)
        {
            ...
            $.each(response.categories, function(key, item){
                ...
                var delete_url = '{{ route("admin.gallerycategories.destroy", ":category") }}';
                delete_url = delete_url.replace(':category', id);
                ...
                $('tbody').append(`<tr>
                        ...
                        <td>
                            ...
                            onclick="deletepost$category(`+item.id+`)" >
...
$(document).on('click', '.active_status', function(e){
    ...
    var urll = '{{ route("admin.gallerycategories.status", ":id") }}';
...
$(document).on('click', '.edit_category', function(e){
    ...
    var urll = '{{ route("admin.gallerycategories.edit", ":gallerycategory") }}';
    urll = urll.replace(':gallerycategory', category_id);
    $.ajax({
        type: 'GET',
        url: urll,
        success: function(response)
    ...
    $("#btn_submit_edit").click(function(e){
        ...
        var category_id = $("#category_edit_id").val();
        var urll = '{{ route("admin.gallerycategories.update", ":gallerycategory") }}';
        urll = urll.replace(':gallerycategory', category_id);
    ...
    $("#btn_submit").click(function(e){
        ...
        var url = '{{ route('admin.gallerycategories.store') }}';
