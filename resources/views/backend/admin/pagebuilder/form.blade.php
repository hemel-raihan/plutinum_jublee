			...
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control" value="{{$custompage->left_margin ?? old('left_margin')}}" name="left_margin" id="" placeholder="EX: 50px">
					</div>

                    <div class="form-group">
						<label for="exampleInputname">Right Margin</label>
						<input type="text" class="form-control" value="{{$custompage->right_margin ?? old('right_margin')}}" name="right_margin" id="" placeholder="EX: 50px">
					</div>
				...
				<div class="card-footer text-end">
					...
					<a href="{{route('admin.custompages.index')}}" class="btn btn-danger mt-1">Cancel</a>
				</div>
			</div>
		</div>
