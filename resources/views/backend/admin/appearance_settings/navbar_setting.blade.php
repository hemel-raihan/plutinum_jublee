                      ...
                      <div class="row">
                          <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$setting->left_margin ?? old('left_margin')}}" name="left_margin" id="" placeholder="EX: 50px">
                              </div>
                          </div>
                          <div class="col-6">
                            <div class="form-group">
                                <label for="exampleInputname">Right Margin :</label>
                                <input type="text" class="form-control" value="{{$setting->right_margin ?? old('right_margin')}}" name="right_margin" id="" placeholder="EX: 50px">
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="col-4">
                            <div class="form-group background_color">
                                ...
                                <input type="text" class="form-control @error('background_color') is-invalid @enderror" value="{{$setting->background_color ?? old('background_color')}}" name="background_color" id="" placeholder="ex. #ffffff">
                            </div>
                          </div>
                          <div class="col-4">
                            <div class="form-group background_color">
                                <label for="exampleInputname">Text Color Code :</label>
                                <input type="text" class="form-control @error('background_color') is-invalid @enderror" value="{{$setting->text_color ?? old('text_color')}}" name="text_color" id="" placeholder="ex. #ffffff">
                            </div>
                          </div>
                          <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="container" class="form-control form-select select2" data-bs-placeholder="Select Container">
                                    ...
                                    <option value="container-lg" {{($setting->container == 'container-lg') ? 'selected' : ''}}  >Full width</option>
                                    <option value="container-sm" {{($setting->container == 'container-sm') ? 'selected' : ''}}>Box Layout</option>
                                </select>
                            </div>
                        </div>
                      </div>
